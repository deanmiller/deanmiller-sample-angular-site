...
constructor(private _FireBase: FirebasecallService,
...
this.form = this.fb.group({
  ...
  workstations: this.fb.group({
    ...
    DaysOld: ['',[Validators.required,Validators.minLength(2)]],
    PruneOldFiles: '',
    PruneFilesOlderThan: ['',[Validators.required,Validators.minLength(2)]],
  ...
  lifecyclemanagement: this.fb.group({
    RemoveOldComputers: '',
    RemoveOldComputersdays: ['',[Validators.required,Validators.minLength(2)]],
    RemoveOldUsers: '',
    RemoveOldUsersdays: ['',[Validators.required,Validators.minLength(2)]]
  }),
  other: this.fb.group({
  ...
  ngOnInit(){ 
    ...
    settings$
      .subscribe(  
        ...
        this.timeout = 600000; //Ten minute timeout
        this.timeOutSettingsPage()
  }
